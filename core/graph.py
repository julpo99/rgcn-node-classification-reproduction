...
from typing import Iterable, Any, Mapping, List, Optional
    ...
    def from_networkx(
        ...
        *,
        ...
        .. seealso::
           ...
           `The Loading from NetworkX example <https://stellargraph.readthedocs.io/en/stable/demos/basics/loading-networkx.html>`__
